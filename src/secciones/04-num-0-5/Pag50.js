...
export const Pag50 = ({playBad, playGood}) => {
    ...
    return (
        <div>
            ...
            <div className="row">
                ...
                <img className="position-absolute p-0" src="static/Diapositivas PNG/50.png" alt="pag-19"/> 
                ...
                <div className="col-6 d-flex justify-content-around adelante">
                    <div className="bg-amarillo border border-dark p-3 p-lg-5 m-lg-3 m-2 img-hover" onClick={()=>{handleClickTrue()}}>
                        <img style={{height:"10vw"}} src="static/Elementosporseparado/5 Números del 0 al 5/frutas.png" alt="img"/>
                    </div>
                    <div className="bg-amarillo border border-dark p-3 p-lg-5 m-lg-3 m-2 img-hover" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"10vw"}} src="static/Elementosporseparado/5 Números del 0 al 5/canasta-con-manzanas.png" alt="img"/>
                    </div>
                </div>
            </div> 
             }
