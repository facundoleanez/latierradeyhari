...
export const Pag45 = ({playBad, playGood}) => {
    ...
    return (
        <div className="row ">
            ...
            <div className="row">
                ...
                <img className="position-absolute p-0" src="static/Diapositivas PNG/45.png" alt="pag-19"/> 
                <div className="">
                    <div className="d-flex position-absolute top-50 start-0 translate-middle-y mx-3 " style={{zIndex:1}}>
                        <div className="bg-amarillo border border-dark p-3 m-lg-3 m-1 img-hover" onClick={()=>{handleClickWrong()}}>
                            <img style={{height:"14vw"}} src="static/Elementosporseparado/5 Números del 0 al 5/1-nena-mirando-la-tele.png" alt="img"/>
                        </div>
                        <div className="bg-amarillo border border-dark p-3 m-lg-3 m-1 img-hover" onClick={()=>{handleClickTrue()}}>
                            <img style={{height:"14vw"}} src="static/Elementosporseparado/5 Números del 0 al 5/2-nenes-mirando-la-tele.png" alt="img"/>
                        </div>
                    </div>
                </div>
            </div> 
