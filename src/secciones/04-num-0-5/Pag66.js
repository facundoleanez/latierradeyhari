            ...
            <div className="row">
                ...
                <div>
                    <div className="d-flex flex-column position-absolute top-50 end-0 translate-middle-y mx-3 " style={{zIndex:1}}>
                        <div className="img-hover btn-success p-1 p-lg-4 m-2 rounded-circle" onClick={()=>{handleClickTrue()}}><h3 style={{fontSize:"5vw"}}>1</h3></div>
                        <div className="img-hover btn-success p-1 p-lg-4 m-2 rounded-circle" onClick={()=>{handleClickWrong()}}><h3 style={{fontSize:"5vw"}}>2</h3></div>
                        <div className="img-hover btn-success p-1 p-lg-4 m-2 rounded-circle" onClick={()=>{handleClickWrong()}}><h3 style={{fontSize:"5vw"}}>5</h3></div>
                    </div>
                </div>
            </div> 
             }
