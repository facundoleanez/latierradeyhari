    ...
    return (
        <div>
            ...
            <div className="row">
                ...
                <div className="col-5 border adelante"></div>
                <div className="col-6 p-0 d-flex justify-content-between adelante">
                    <div className="bg-amarillo border border-dark img-hover" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"20vw"}} src="static/Elementosporseparado/5 Números del 0 al 5/canasta-con-ovillos.png" alt="img"/>
                    </div>
                    <div className="bg-amarillo border border-dark img-hover" onClick={()=>{handleClickTrue()}}>
                        <img style={{height:"20vw"}} src="static/Elementosporseparado/5 Números del 0 al 5/canasta-vacia.png" alt="img"/>
                    </div>
                </div>
            </div> 
             }
