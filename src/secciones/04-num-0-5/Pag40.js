...
export const Pag40 = ({playBad, playGood}) => {
            ...
            <div className="row">
                ...
                <div className="">
                    <div className="d-flex position-absolute top-50 start-0 translate-middle-y mx-3 " style={{zIndex:1}}>
                        <div className="bg-amarillo border border-dark p-1 m-2 img-hover" onClick={()=>{handleClickWrong()}}>
                            <img style={{height:"11vw"}} src="static/Elementosporseparado/5 Números del 0 al 5/1-auto.png" alt="img"/>
                        </div>
                        <div className="bg-amarillo border border-dark p-1 m-2 img-hover" onClick={()=>{handleClickTrue()}}>
                            <img style={{height:"11vw"}} src="static/Elementosporseparado/5 Números del 0 al 5/2-autos.png" alt="img"/>
                        </div>
                    </div>
                </div>
            </div> 
