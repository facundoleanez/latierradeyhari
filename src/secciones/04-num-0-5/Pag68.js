        ...
        <div>
            ...
            <div className="row">
                ...
                <div className="col-2 d-flex flex-column adelante text-center justify-content-around" style={{height:"85vh"}}>
                    <div className="img-hover btn-success p-2 p-lg-4 m-2 rounded-circle fuente-1 ancho-10 alto-10" onClick={()=>{handleClickWrong()}}><h3 style={{fontSize:"5vw"}}>4</h3></div>
                    <div className="img-hover btn-success p-2 p-lg-4 m-2 rounded-circle fuente-1 ancho-10 alto-10" onClick={()=>{handleClickTrue()}}><h3 style={{fontSize:"5vw"}}>2</h3></div>
