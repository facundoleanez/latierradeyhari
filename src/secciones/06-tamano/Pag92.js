...
export const Pag92 = ({playBad, playGood}) => {
    ...
    return (
        <>
            ...
            <div className="row p-3 p-lg-5">
                <img className="position-absolute top-50 start-50 translate-middle p-0 m-0" src="static/Diapositivas PNG/92.png" alt="pag-19"/>
                ...
                <div className="col-8 adelante">
                    <div className="row">
                        <div className="col-4">
                            <img className="img-hover" onClick={()=>{handleClickTrue()}} style={{height:"14vw"}} src="static/Elementosporseparado/8 Nocion de tamaño/oso.png" alt="img"/>
                        </div>
                        <div className="col-4">
