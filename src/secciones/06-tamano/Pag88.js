...
export const Pag88 = ({playBad, playGood}) => {
    ...
    return (
        <>
            ...
            <div className="row p-3 p-lg-5">
                <img className="position-absolute top-50 start-50 translate-middle p-0 m-0" src="static/Diapositivas PNG/88.png" alt="pag-19"/>
                ...
                <div className="col-8 adelante">
                    <div className="row text-center">
                        ...
                        <div className="col-4">
                            <img className={`${good? "d-none" : "img-hover"}`} onClick={()=>{handleClickTrue()}} style={{height:"14vw"}} src="static/Elementosporseparado/8 Nocion de tamaño/perrito.png" alt="img"/>
                        </div>
                        <div className="col-4">
                            <img className="img-hover" onClick={()=>{handleClickWrong()}} style={{height:"9vw"}} src="static/Elementosporseparado/8 Nocion de tamaño/perrito.png" alt="img"/>
                        </div>
                    </div>
                    <div className="row text-center pt-3">
                        ...
                        <div className="col-4">
                            <img className="img-hover" style={{height:"10vw"}} src="static/Elementosporseparado/8 Nocion de tamaño/comida-azul.png" alt="img"/>
                        </div>
                    </div>
                </div>
            </div>
