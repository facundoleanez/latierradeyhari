...
export const Pag151 = ({playBad, playGood}) => {
    ...
    return (
        <>
            ...
            <div className="row">
                <img className="position-absolute p-0" src="static/Diapositivas PNG/151.png" alt="pag-19"/> 
                ...
                <div className="col-2 adelante d-flex flex-column justify-content-around alto-libro">
                    <img className="img-hover ancho-10" onClick={()=>{handleClickWrong()}} src="static/Elementosporseparado/12 Suma y resta/5-celeste.png" alt="img"/>
                    ...
                    <img className={`img-hover ancho-10 ${good ? "animate__animated animate__rotateIn" : ""}`} onClick={()=>{handleClickTrue()}} src="static/Elementosporseparado/12 Suma y resta/3-celeste.png" alt="img"/>
                </div>
            </div> 
             }
        </>
