        ...
        <>
            ...
            <div className="row">
                ...
                <div className="col-5 adelante text-center">
                    ...
                    <img className={turnOff ? "d-none" : "img-hover ancho-5 m-lg-3 m-1"} onClick={()=>{handleClickTurnOff()}} src="static/Elementosporseparado/12 Suma y resta/muñeca.png" alt="img"/>
                    <img className={turnOff ? "d-none" : "img-hover ancho-5 m-lg-3 m-1"} onClick={()=>{handleClickTurnOff()}} src="static/Elementosporseparado/12 Suma y resta/muñeca.png" alt="img"/>
                    <img className={turnOff ? "d-none" : "img-hover ancho-5 m-lg-3 m-1"} onClick={()=>{handleClickTurnOff()}} src="static/Elementosporseparado/12 Suma y resta/muñeca.png" alt="img"/><br/>
