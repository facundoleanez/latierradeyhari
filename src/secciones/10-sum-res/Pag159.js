...
export const Pag159 = ({playBad, playGood}) => {
    ...
    return (
        <>
            ...
            <div className="row">
                <img className="position-absolute p-0" src="static/Diapositivas PNG/159.png" alt="pag-19"/> 
                ...
                <div className="col-3 adelante d-flex flex-column justify-content-around alto-libro align-items-center">
                    <img className={`img-hover ancho-10 ${good ? "animate__animated animate__rotateIn" : ""}`} onClick={()=>{handleClickTrue()}} src="static/Elementosporseparado/12 Suma y resta/9-naranja.png" alt="img"/>
                    ...
                    <img className="img-hover ancho-10" onClick={()=>{handleClickWrong()}} src="static/Elementosporseparado/12 Suma y resta/5-naranja.png" alt="img"/>
                </div>
                <div className="col-5"></div>
                {
                    good &&
                    <div className="col-1 adelante d-flex flex-column justify-content-center">
                        <img className="img-hover ancho-10" src="static/Elementosporseparado/12 Suma y resta/9-naranja.png" alt="img"/>
                    </div>
