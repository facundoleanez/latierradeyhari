...
export const Pag157 = ({playBad, playGood}) => {
    ...
    return (
        <>
            ...
            <div className="row ">
                <img className="position-absolute p-0" src="static/Diapositivas PNG/157.png" alt="pag-19"/> 
                ...
                <div className="col-3 adelante d-flex flex-column justify-content-around alto-libro align-items-center">
                    ...
                    <img className="img-hover ancho-10" onClick={()=>{handleClickWrong()}} src="static/Elementosporseparado/12 Suma y resta/10-naranja.png" alt="img"/>
                </div>
