...
export const Pag108 = ({playBad, playGood}) => {
    ...
    return (
        <div>
            ...
            <div className="row text-center">
                <img className="position-absolute p-0" src="static/Diapositivas PNG/108.png" alt="pag-19"/> 
                ...
                <div className="row justify-content-evenly">
                    <div className="col-4 bg-amarillo adelante border border-dark p-2 m-lg-3 m-1 img-hover" onClick={()=>{handleClickTrue()}}>
                        <img style={{height:"27vw"}} src="static/Elementosporseparado/10 Números del 6 al 10/6-manzanas.png" alt="img"/>
                    </div>
                    <div className="col-4 bg-amarillo adelante border border-dark p-2 m-lg-3 m-1 img-hover" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"27vw"}} src="static/Elementosporseparado/10 Números del 6 al 10/5-cerditos.png" alt="img"/>
                    </div>
                </div>
            </div> 
             }
