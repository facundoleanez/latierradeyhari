...
export const Pag115 = ({playBad, playGood}) => {
            ...
            <div className="row text-center">
                ...
                <div className="row justify-content-evenly">
                    <div className="col-4 bg-amarillo adelante border border-dark p-2 m-lg-3 m-1 img-hover" onClick={()=>{handleClickTrue()}}>
                        <img style={{height:"27vw"}} src="static/Elementosporseparado/10 Números del 6 al 10/mariposas-(7).png" alt="img"/>
                    </div>
                    <div className="col-4 bg-amarillo adelante border border-dark p-2 m-lg-3 m-1 img-hover" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"27vw"}} src="static/Elementosporseparado/10 Números del 6 al 10/perritos.png" alt="img"/>
                    </div>
                </div>
            </div> 
             }
