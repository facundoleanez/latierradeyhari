...
export const Pag130 = ({playBad, playGood}) => {
    ...
    return (
        <div>
            ...
            <div className="row text-center">
                <img className="position-absolute p-0" src="static/Diapositivas PNG/129.png" alt="pag-19"/> 
                ...
                <div className="row justify-content-evenly">
                    <div className="col-4 bg-amarillo adelante border border-dark p-2 m-lg-3 m-1 img-hover" onClick={()=>{handleClickTrue()}}>
                        <img style={{height:"27vw"}} src="static/Elementosporseparado/10 Números del 6 al 10/9-corazones.png" alt="img"/>
                    </div>
                    <div className="col-4 bg-amarillo adelante border border-dark p-2 m-lg-3 m-1 img-hover" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"27vw"}} src="static/Elementosporseparado/10 Números del 6 al 10/mariposas.png" alt="img"/>
                    </div>
                </div>
            </div> 
             }
