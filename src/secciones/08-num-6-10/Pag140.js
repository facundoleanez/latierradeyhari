...
export const Pag140 = ({playBad, playGood}) => {
    ...
    return (
        <div>
            ...
            <div className="row">
                <img className="position-absolute p-0" src="static/Diapositivas PNG/140.png" alt="pag-19"/> 
                ...
                <div className="col-4 adelante d-flex flex-column text-center justify-content-center" style={{height:"85vh"}}>
                    ...
                    <div className="img-hover p-3" onClick={()=>{handleClickTrue()}}>
                        <img style={{height:"10vw"}} src="static/Elementosporseparado/10 Números del 6 al 10/7-rojo.png" alt="img"/>
                    </div>
                    <div className="img-hover p-3" onClick={()=>{handleClickWrong()}}>
