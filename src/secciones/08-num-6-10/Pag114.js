...
export const Pag114 = ({playBad, playGood}) => {
    ...
    return (
        <>
            ...
            <div className="row text-center">
                <img className="position-absolute top-50 start-50 translate-middle p-0 m-0" src="static/Diapositivas PNG/114.png" alt="pag-19"/>
