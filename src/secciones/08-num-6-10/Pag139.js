...
export const Pag139 = ({playBad, playGood}) => {
    ...
    return (
        <div>
            ...
            <div className="row">
                <img className="position-absolute p-0" src="static/Diapositivas PNG/139.png" alt="pag-19"/> 
                ...
                <div className="col-4 adelante d-flex flex-column text-center justify-content-center" style={{height:"85vh"}}>
                    ...
                    <div className="img-hover p-3" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"10vw"}} src="static/Elementosporseparado/10 Números del 6 al 10/5-rojo.png" alt="img"/>
                    </div>
                    <div className="img-hover p-3" onClick={()=>{handleClickWrong()}}>
