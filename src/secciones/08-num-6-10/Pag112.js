...
export const Pag112 = ({playBad, playGood}) => {
    ...
    return (
        <div>
            ...
            <div className="row">
                <img className="position-absolute p-0" src="static/Diapositivas PNG/112.png" alt="pag-19"/> 
                ...
                <div className="col-4 adelante d-flex flex-column text-center justify-content-center" style={{height:"85vh"}}>
                    <div className="img-hover p-3" onClick={()=>{handleClickTrue()}}>
                        <img style={{height:"10vw"}} src="static/Elementosporseparado/10 Números del 6 al 10/2-verde.png" alt="img"/>
                    </div>
                    <div className="img-hover p-3" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"10vw"}} src="static/Elementosporseparado/10 Números del 6 al 10/1-verde.png" alt="img"/>
                    </div>
                    <div className="img-hover p-3" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"11vw"}} src="static/Elementosporseparado/10 Números del 6 al 10/0-verde.png" alt="img"/>
                    </div>
                </div>
