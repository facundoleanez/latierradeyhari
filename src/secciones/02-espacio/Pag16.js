            ...
            <div className="row">
                ...
                <div className="">
                    ...
                    <div className="d-flex flex-column position-absolute top-50 start-0 translate-middle-y mx-3 " style={{zIndex:1}}>
                        <p className="btn btn-success" style={{fontSize:"1.3vw"}} onClick={()=>{handleClickWrong()}}>ARRIBA DE LA MESA</p>
                        <p className="btn btn-primary" style={{fontSize:"1.3vw"}} onClick={()=>{handleClickTrue()}}>DEBAJO DE LA MESA</p>
