            ...
            <div className="row">
                ...
                <div>
                    ...
                    <div className="d-flex flex-column position-absolute top-50 start-0 translate-middle-y px-4 px-md-5 pt-5" style={{zIndex:1}}>
                        <p className="btn btn-success letra-titulo my-md-4" style={{fontSize:"1.8vw"}} onClick={()=>{handleClickTrue()}}>ARRIBA DE LA MESA</p>
                        <p className="btn btn-primary letra-titulo my-md-4" style={{fontSize:"1.8vw"}} onClick={()=>{handleClickWrong()}}>DEBAJO DE LA MESA</p>
