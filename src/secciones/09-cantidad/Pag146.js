...
export const Pag146 = ({playBad, playGood}) => {
    ...
    return (
        <div>
            ...
            <div className="row">
                <img className="position-absolute p-0" src="static/Diapositivas PNG/146.png" alt="pag-19"/> 
                ...
                <div className="col-10 row justify-content-evenly">
                    <div className="col-3 bg-amarillo adelante border border-dark img-hover py-4" onClick={()=>{handleClickTrue()}}>
                        <img style={{height:"10vw"}} src="static/Elementosporseparado/11 Nocion de cantidad/canasta-muchas-pelotas.png" alt="img"/>
                    </div>
                    <div className="col-3 bg-amarillo adelante border border-dark img-hover py-4" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"9vw"}} src="static/Elementosporseparado/11 Nocion de cantidad/canasta-vacia.png" alt="img"/>
                    </div>
                    <div className="col-3 bg-amarillo adelante border border-dark img-hover py-4" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"9vw"}} src="static/Elementosporseparado/11 Nocion de cantidad/canasta-pocas-pelotas.png" alt="img"/>
                    </div>
                </div>
            </div> 
             }
