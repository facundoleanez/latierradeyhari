...
export const Pag149 = ({playBad, playGood}) => {
    ...
    return (
        <div>
            ...
            <div className="row">
                <img className="position-absolute p-0" src="static/Diapositivas PNG/149.png" alt="pag-19"/> 
                ...
                <div className="col-10 row justify-content-evenly">
                    <div className="col-3 bg-amarillo adelante border border-dark  img-hover" onClick={()=>{handleClickTrue()}}>
                        <img style={{height:"18vw"}} src="static/Elementosporseparado/11 Nocion de cantidad/pocas-flores.png" alt="img"/>
                    </div>
                    <div className="col-3 bg-amarillo adelante border border-dark  img-hover" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"18vw"}} src="static/Elementosporseparado/11 Nocion de cantidad/sin-flores.png" alt="img"/>
                    </div>
                    <div className="col-3 bg-amarillo adelante border border-dark  img-hover" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"18vw"}} src="static/Elementosporseparado/11 Nocion de cantidad/muchas-flores.png" alt="img"/>
                    </div>
                </div>
            </div> 
             }
