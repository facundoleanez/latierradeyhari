...
export const Pag148 = ({playBad, playGood}) => {
    ...
    return (
        <div>
            ...
            <div className="row">
                <img className="position-absolute p-0" src="static/Diapositivas PNG/148.png" alt="pag-19"/> 
                ...
                <div className="col-10 row justify-content-evenly">
                    <div className="col-3 bg-amarillo adelante border border-dark  img-hover" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"18vw"}} src="static/Elementosporseparado/11 Nocion de cantidad/regalo-c-pocos-globos.png" alt="img"/>
                    </div>
                    <div className="col-3 bg-amarillo adelante border border-dark  img-hover" onClick={()=>{handleClickWrong()}}>
                        <img style={{height:"15vw"}} src="static/Elementosporseparado/11 Nocion de cantidad/regalo-s-globos.png" alt="img"/>
                    </div>
                    <div className="col-3 bg-amarillo adelante border border-dark  img-hover" onClick={()=>{handleClickTrue()}}>
                        <img style={{height:"18vw"}} src="static/Elementosporseparado/11 Nocion de cantidad/regalo-muchos-globos.png" alt="img"/>
                    </div>
                </div>
            </div> 
             }
