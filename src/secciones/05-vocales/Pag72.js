        ...
        <>
            ...
            <div className="row p-3 p-lg-5">
                ...
                <div className="col-8" style={{zIndex:1}}>
                    ...
                    <img className={`img-hover ${isSelected[0]? "animate__animated animate__flip selected" : ""}`} onClick={()=>{handleClickTrue(0)}} style={{height:"10vw"}} src="static/Elementosporseparado/7 Las vocales/auto.png" alt="img"/>
                    ...
                    <img className={`img-hover ${isSelected[1]? "animate__animated animate__flip selected" : ""}`} onClick={()=>{handleClickTrue(1)}} style={{height:"10vw"}} src="static/Elementosporseparado/7 Las vocales/ananá.png" alt="img"/>
                    ...
                    <img className={`img-hover ${isSelected[2]? "animate__animated animate__flip selected" : ""}`} onClick={()=>{handleClickTrue(2)}} style={{height:"10vw"}} src="static/Elementosporseparado/7 Las vocales/angel.png" alt="img"/>
                    ...
                    <img className={`img-hover ${isSelected[3]? "animate__animated animate__flip selected" : ""}`} onClick={()=>{handleClickTrue(3)}} style={{height:"5vw"}} src="static/Elementosporseparado/7 Las vocales/avion.png" alt="img"/>
                    <div className="row bg-amarillo border border-dark justify-content-around m-2 p-2" style={{height:"10vw"}}>
                        <div className="col-2 bg-white rounded-circle py-3 text-center">{ isSelected[0] && <img style={{height:"5vw"}} src="static/Elementosporseparado/7 Las vocales/auto.png" alt="img" /> }</div>
                        <div className="col-2 bg-white rounded-circle py-3 text-center">{ isSelected[1] && <img style={{height:"6vw"}} src="static/Elementosporseparado/7 Las vocales/ananá.png" alt="img" /> }</div>
                        <div className="col-2 bg-white rounded-circle py-3 text-center">{ isSelected[2] && <img style={{height:"6vw"}} src="static/Elementosporseparado/7 Las vocales/angel.png" alt="img" /> }</div>
                        <div className="col-2 bg-white rounded-circle py-3 text-center">{ isSelected[3] && <img style={{height:"4vw"}} src="static/Elementosporseparado/7 Las vocales/avion.png" alt="img" /> }</div>
                    </div>
                </div>
            </div>
            }
