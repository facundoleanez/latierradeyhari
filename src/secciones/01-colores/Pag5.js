        ...
        <div className="container">
            { completed ? ( <BienHecho setCompleted={setCompleted}/> ) :
                <div className="row">
                    ...
                    <div className="col-6 bg-amarillo p-5" style={{ borderRadius:"50%", zIndex:2, height:"35vw", width:"35vw" }}>
                      <div className="p-4">
                        ...
                        <img className={"img-hover"} onClick={()=>playBad()} alt="img-1" style={{height:"4vw"}} src="static/Elementosporseparado/2Coloresprimarios/Rojo/Corazon-azul.png" />
                        ...
                        <img className={"img-hover"} onClick={()=>playBad()} alt="img-1" style={{height:"4vw"}} src="static/Elementosporseparado/2Coloresprimarios/Rojo/Corazon-naranja.png" />
                        ...
                        <img className={"img-hover"} onClick={()=>playBad()} alt="img-1" style={{height:"4vw"}} src="static/Elementosporseparado/2Coloresprimarios/Rojo/Corazon-verde.png" />
                        <img className={"img-hover"} onClick={()=>playBad()} alt="img-1" style={{height:"4vw"}} src="static/Elementosporseparado/2Coloresprimarios/Rojo/Corazon-verde-agua.png" />
                        <img className={"img-hover"} onClick={()=>playBad()} alt="img-1" style={{height:"4vw"}} src="static/Elementosporseparado/2Coloresprimarios/Rojo/Corazon-amarillo.png" />
                        ...
                        <img className={"img-hover"} onClick={()=>playBad()} alt="img-1" style={{height:"4vw"}} src="static/Elementosporseparado/2Coloresprimarios/Rojo/Corazon-azul.png" />
                        <img className={"img-hover"} onClick={()=>playBad()} alt="img-1" style={{height:"4vw"}} src="static/Elementosporseparado/2Coloresprimarios/Rojo/Corazon-celeste.png" />
