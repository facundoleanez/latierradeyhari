            ...
            <>
                ...
                <div className="row pt-lg-5">
                    ...
                    <div  className="col-2 border border-3 border-dark bg-amarillo">
                        <img style={{width: "5vw"}} src='/static/Elementosporseparado/2Coloresprimarios/Rojo/Regalo.png' alt="img" />

                    </div>
                    <div onClick={()=>{handleSelect(1)}} className={`col-2 border border-3 ${isSelected[1] ? "selected" : "border-dark"} bg-amarillo img-hover`}>
                        <img style={{width: "5vw"}} src='/static/Elementosporseparado/2Coloresprimarios/Rojo/Botón.png' alt="img" />
                    </div>
                    <div className="col-2 border border-3 border-dark bg-amarillo">
                        <img style={{width: "5vw"}} src='/static/Elementosporseparado/2Coloresprimarios/Rojo/Paraguas.png' alt="img" />
                    </div>
                    <div onClick={()=>{handleSelect(2)}} className={`col-2 border border-3 ${isSelected[2] ? "selected" : "border-dark"} bg-amarillo img-hover`}>
                        <img style={{width: "5vw"}} src='/static/Elementosporseparado/2Coloresprimarios/Rojo/Crayón.png' alt="img" />
                    </div>
                </div>
                <div className="row ">
                <div className="col-1"></div>
                    ...
                    <div onClick={()=>{handleSelect(3)}} className={`col-2 border border-3 ${isSelected[3] ? "selected" : "border-dark"} bg-amarillo img-hover`}>
                        <img style={{width: "5vw"}} src='/static/Elementosporseparado/2Coloresprimarios/Rojo/Cereza.png' alt="img" />

                    </div>
                    <div className="col-2 border border-3 border-dark bg-amarillo">
                        <img style={{width: "5vw"}} src='/static/Elementosporseparado/2Coloresprimarios/Rojo/Pasta-dental.png' alt="img"/>

                    </div>
                    <div onClick={()=>{handleSelect(4)}} className={`col-2 border border-3 ${isSelected[4] ? "selected" : "border-dark"} bg-amarillo img-hover`}>
                        <img style={{width: "5vw"}} src='/static/Elementosporseparado/2Coloresprimarios/Rojo/Vaquita-de-san-antonio.png' alt="img"/>
                    </div>
                    <div className="col-2 border border-3 border-dark bg-amarillo">
                        <img style={{width: "5vw"}} src='/static/Elementosporseparado/2Coloresprimarios/Rojo/Cactus.png' alt="img"/>
                    </div>
                </div>
            </>
            }
