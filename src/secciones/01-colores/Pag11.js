            ...
            { completed ? ( <BienHecho setCompleted={setCompleted}/> ) :
                <div className="row">
                    ...
                    <div className="bg-amarillo overflow-hidden m-3 m-sm-5 p-3 p-xl-5 position-absolute bottom-0 end-0" style={{ borderRadius:"45%", width:"50%", zIndex:2}}>
                        ...
                        <img className="img-hover" onClick={()=>playBad()} alt="img-1" style={{height:"3vw"}} src="static/Elementosporseparado/2Coloresprimarios/Amarillo/sol-azul.png" />
                        <img className="img-hover" onClick={()=>playBad()} alt="img-1" style={{height:"3vw"}} src="static/Elementosporseparado/2Coloresprimarios/Amarillo/sol-naranja.png" />
                        ...
                        <img className="img-hover" onClick={()=>playBad()} alt="img-1" style={{height:"3vw"}} src="static/Elementosporseparado/2Coloresprimarios/Amarillo/sol-verde.png" />
                        <img className="img-hover" onClick={()=>playBad()} alt="img-1" style={{height:"3vw"}} src="static/Elementosporseparado/2Coloresprimarios/Amarillo/sol-naranja.png" />
                        <img className="img-hover" onClick={()=>playBad()} alt="img-1" style={{height:"3vw"}} src="static/Elementosporseparado/2Coloresprimarios/Amarillo/sol-violeta.png" />
                        ...
                        <img className="img-hover" onClick={()=>playBad()} alt="img-1" style={{height:"3vw"}} src="static/Elementosporseparado/2Coloresprimarios/Amarillo/sol-azul.png" />
                        <img className="img-hover" onClick={()=>playBad()} alt="img-1" style={{height:"3vw"}} src="static/Elementosporseparado/2Coloresprimarios/Amarillo/sol-rosa.png" />
