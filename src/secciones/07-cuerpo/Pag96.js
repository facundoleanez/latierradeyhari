...
export const Pag96 = ({playBad, playGood}) => {
    ...
    return (
        <>
            ...
            <div className="row p-3 p-lg-5">
                <img className="position-absolute top-50 start-50 translate-middle p-0 m-0" src="static/Diapositivas PNG/96.png" alt="pag-19"/>
                ...
                <div className="col-7 adelante px-lg-5 px-4">
                    ...
                    <div className={`px-md-4 ${good ? "text-end" : " "}`}>
                        <img className="img-hover mx-4" onClick={()=>{handleClickTrue()}} style={{height:"4vw"}} src="static/Elementosporseparado/9 El cuerpo humano/boca.png" alt="img"/>
                    </div>
                </div>
            </div>
            }
