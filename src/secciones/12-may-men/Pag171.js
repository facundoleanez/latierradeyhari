...
export const Pag171 = ({playBad, playGood}) => {
    ...
    return (
        <>
            <div className="row">
                <img className="position-absolute p-0" src="static/Diapositivas PNG/171.png" alt="pag-19"/> 
                ...
                <div className="col-2 adelante">
                    {good && <img className="alto-10 border border-dark" src="static/Elementosporseparado/menor.png" alt="img"/> }
                </div>
                <div className="col-2"></div>
                <div className="col-4 adelante d-flex flex-column align-items-center">
                    <img className="ancho-10 img-hover border border-dark m-2" onClick={()=>{handleClickTrue()}} src="static/Elementosporseparado/menor.png" alt="img"/>
                    <img className="ancho-10 img-hover border border-dark m-2" onClick={()=>{handleClickWrong()}} src="static/Elementosporseparado/igual.png" alt="img"/>
