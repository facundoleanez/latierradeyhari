        ...
        <>
            ...
            <div className="row">
                ...
                <div className="col-3 adelante text-center">
                    ...
                    <img className="ancho-10 img-hover  m-lg-2" onClick={()=>{handleClickTrue(0)}} src="static/Elementosporseparado/10 Números del 6 al 10/7-fucsia.png" alt="img"/>
                    <img className="ancho-10 img-hover  m-lg-2" onClick={()=>{handleClickWrong()}} src="static/Elementosporseparado/10 Números del 6 al 10/5-verde.png" alt="img"/>
                </div>
                <div className="col-6 d-flex align-items-center justify-content-center adelante">
                    {isSelected[0] && <img className="ancho-10 img-hover m-2" src="static/Elementosporseparado/10 Números del 6 al 10/sol-4.png" alt="img"/> }
                    <img className="ancho-10 img-hover m-2" src="static/Elementosporseparado/10 Números del 6 al 10/sol-9.png" alt="img"/>
                    {isSelected[1] && <img className="ancho-10 img-hover m-2" src="static/Elementosporseparado/10 Números del 6 al 10/sol-11.png" alt="img"/> }
                </div>
                <div className="col-3 adelante text-center">
