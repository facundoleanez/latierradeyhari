    ...
    return (
        <>
            { completed ? ( <BienHecho setCompleted={setCompleted}/> ) :
                <div className="row">
                    <img className="position-absolute top-50 start-50 translate-middle p-0" src="static/Diapositivas PNG/25.png" alt="pag-5"/> 
                    ...
                    <div className="col-6 adelante">                        
                        <div className="row text-center" >
                            <div onClick={()=>{handleSelect(0)}} className={`col-3 border p-2 ${isSelected[0] ? "selected animate__animated animate__jello" : "border-dark"} bg-amarillo img-hover`} >
                            ...
                            <div onClick={()=>{handleSelect(1)}} className={`col-3 border p-2 ${isSelected[1] ? "selected selected animate__animated animate__jello" : "border-dark"} bg-amarillo img-hover`}>
                        ...
                        <div className="row text-center">
                            ...
                            <div onClick={()=>{handleSelect(2)}} className={`col-3 border   p-2 ${isSelected[2] ? "selected selected animate__animated animate__jello" : "border-dark"} bg-amarillo img-hover`}>
                                <img style={{width: " 6vw"}} src='/static/Elementosporseparado/4 Formas geométricas/sandia.png' alt="img" />
                            </div>
                            <div onClick={()=>{handleSelect(3)}} className={`col-3 border   p-2 ${isSelected[3] ? "selected selected animate__animated animate__jello" : "border-dark"} bg-amarillo img-hover`}>
