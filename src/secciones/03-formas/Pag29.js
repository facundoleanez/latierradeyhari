                    ...
                    <div className="row position-absolute top-50 start-50 translate-middle justify-content-center" style={{zIndex:1}}>
                        <div className="col-8" >
                            ...
                            <div className="row text-center justify-content-center m-3 border border-dark border-2" >
                                <div className="col-3 bg-amarillo p-2">
                                    <img style={{width: " 6vw"}} src={`/static/Elementosporseparado/4 Formas geométricas/circulo-azul${isSelected[0] ? "" : "-linea"}.png`} alt="img" />
                                </div>
                                <div className="col-3 bg-amarillo p-2">
                                    <img style={{width: " 6vw"}} src='/static/Elementosporseparado/4 Formas geométricas/cuadrado-fucsia.png' alt="img"/>
                                ...
                                <div className="col-3 bg-amarillo p-2">
                                    <img style={{width: " 6vw"}} src={`/static/Elementosporseparado/4 Formas geométricas/cuadrado-fucsia${isSelected[1] ? "" : "-linea"}.png`} alt="img" />
                                </div>
                            </div>
                        </div>
